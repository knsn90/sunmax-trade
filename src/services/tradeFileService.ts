...
const FILE_SELECT = `
  ...
  proforma_ref, register_no, septi_ref, insurance_tr, insurance_ir, eta, vessel_name, currency,
  purchase_currency, sale_currency, freight_cost, freight_currency, parent_file_id, batch_no,
...
const FILE_DETAIL_SELECT = `
  ...
  purchase_currency, sale_currency, freight_cost, freight_currency, parent_file_id,
...
const FILE_SELECT_ALL = `
  ...
  purchase_currency, sale_currency, currency, freight_cost, freight_currency, parent_file_id, batch_no,
  ...
  async convertToSale(
    ...
    const { data, error } = await supabase
      ...
      .update({
        ...
        freight_currency: input.freight_currency,
