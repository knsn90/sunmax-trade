...
export const priceListSchema = z.object({
  ...
  currency:    z.enum(['USD', 'EUR', 'TRY', 'AED']).default('USD'),
...
export const saleConversionSchema = z.object({
  ...
  purchase_currency: z.enum(['USD', 'EUR', 'TRY', 'AED']).default('USD'),
  sale_currency: z.enum(['USD', 'EUR', 'TRY', 'AED']).default('USD'),
...
export const companySettingsSchema = z.object({
  ...
  default_currency: z.enum(['USD', 'EUR', 'TRY', 'AED']).default('USD'),
