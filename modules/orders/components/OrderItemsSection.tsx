...
const styles = StyleSheet.create({
  heading: { fontSize: 15, fontWeight: '700', color: C.textPrimary, marginBottom: 14 },
  subHeading: { fontSize: 13, fontWeight: '700', color: C.textSecondary, marginBottom: 8, marginTop: 12 },
  itemsCard: {
  ...
  itemName: { fontSize: 14, color: C.textPrimary, fontWeight: '500' },
  itemQty: { fontSize: 12, color: C.textMuted, fontWeight: '600' },
  itemPrice: { fontSize: 14, fontWeight: '700', color: C.primary, marginRight: 10 },
  ...
  searchInput: {
    ...
    fontSize: 13, color: C.textPrimary, marginBottom: 4,
  },
  ...
  catalogRow: {
    ...
    paddingHorizontal: 4, borderBottomWidth: 1, borderBottomColor: C.border, gap: 10,
  },
  addIcon: {
  ...
  catalogName: { flex: 1, fontSize: 13, color: C.textPrimary, fontWeight: '500' },
  catalogPrice: { fontSize: 13, fontWeight: '700', color: C.primary },
  emptyServices: { paddingVertical: 24, alignItems: 'center', gap: 6 },
  emptyServicesText: { fontSize: 14, color: C.textSecondary, textAlign: 'center' },
  emptyServicesSubText: { fontSize: 12, color: C.textMuted, textAlign: 'center' },
  manualForm: { marginTop: 8, padding: 12, backgroundColor: C.background, borderRadius: 10, borderWidth: 1, borderColor: C.border },
  manualInput: {
    borderWidth: 1.5, borderColor: C.border, borderRadius: 8,
    paddingHorizontal: 12, paddingVertical: 8, fontSize: 13,
    color: C.textPrimary, backgroundColor: C.surface, marginBottom: 8,
  },
  manualRow: { flexDirection: 'row', gap: 8, alignItems: 'center' },
  manualAddBtn: { backgroundColor: C.primary, paddingHorizontal: 14, paddingVertical: 9, borderRadius: 8 },
  manualAddBtnText: { color: '#FFFFFF', fontWeight: '700', fontSize: 13 },
  manualCancelBtn: { paddingHorizontal: 10, paddingVertical: 9 },
  manualCancelText: { color: C.textSecondary, fontSize: 13 },
  manualBtn: {
    marginTop: 10, paddingVertical: 10, borderRadius: 8,
    borderWidth: 1.5, borderColor: C.border, alignItems: 'center',
  },
  manualBtnText: { fontSize: 13, color: C.textSecondary, fontWeight: '600' },
});
